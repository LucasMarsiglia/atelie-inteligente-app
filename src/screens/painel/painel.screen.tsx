      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            ...
            <CardContent>
              <div className="text-sm text-gray-600">{stats.pecasAtivas} ativas</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-sm text-gray-600">Todos os tempos</div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-6">
          ...
          <Card
            className="hover:shadow-lg transition-shadow cursor-pointer"
            // onClick={() => router.push('/painel/encomendas')}
          >
            <CardHeader>
